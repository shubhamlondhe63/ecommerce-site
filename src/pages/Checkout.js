                                            ...
                                            <li key={address.email} className="flex justify-between gap-x-6 py-5 ">
                                                ...
                                                <input
                                                    ...
                                                    <div className="min-w-0 flex-auto ">
                                                        ...
                                                        <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.city}, {address.pincode}, {address.state}</p>
                                               
                                                    </div>
                                                </div>
                                                <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                                    <p className="text-sm leading-6 text-gray-900">{address.email}</p>
                                                    <p className="text-sm leading-6 text-gray-900">{address.mobileNumber}</p>
                                                </div>
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className='lg:col-span-2'>
                        <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                <h3 className="text-4xl my-3 font-bold tracking-tight text-gray-900">Cart</h3>
